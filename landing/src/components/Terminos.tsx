...
const SECTIONS_ES: Section[] = [
  {
    id: 'que-es', num: '1', label: 'Qué es Kongtrol', title: 'Qué es Kongtrol',
  ...
  {
    id: 'garantia', num: '2', label: 'Sin garantía', title: 'Software "tal cual", sin garantía',
    callout: 'warn',
  ...
  {
    id: 'beta', num: '3', label: 'Beta activa', title: 'Software en beta activa',
  ...
  {
    id: 'responsabilidad', num: '4', label: 'Tu responsabilidad', title: 'Tu responsabilidad',
    body: [`Eres el único responsable de:`],
  },
  {
    id: 'binarios', num: '5', label: 'Binarios no firmados', title: 'Binarios no firmados',
  ...
  {
    id: 'privacidad', num: '6', label: 'Privacidad', title: 'Privacidad',
  ...
  {
    id: 'cambios', num: '7', label: 'Cambios', title: 'Cambios a estos términos',
...
const SECTIONS_EN: Section[] = [
  {
    id: 'que-es', num: '1', label: 'What it is', title: 'What Kongtrol is',
  ...
  {
    id: 'garantia', num: '2', label: 'No warranty', title: 'Software provided "as is"',
    callout: 'warn',
  ...
  {
    id: 'beta', num: '3', label: 'Active beta', title: 'Active beta software',
  ...
  {
    id: 'responsabilidad', num: '4', label: 'Your responsibility', title: 'Your responsibility',
    body: [`You are solely responsible for:`],
  },
  {
    id: 'binarios', num: '5', label: 'Unsigned binaries', title: 'Unsigned binaries',
  ...
  {
    id: 'privacidad', num: '6', label: 'Privacy', title: 'Privacy',
  ...
  {
    id: 'cambios', num: '7', label: 'Changes', title: 'Changes to these terms',
