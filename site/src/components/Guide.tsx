          ...
          <div className="guide-content" ref={contentRef}>
            ...
            <div id="prereqs" className="guide-section">
              ...
              <div className="callout" style={{ marginTop: 12 }}>
                ...
                Kongtrol llama directamente al CLI de cada uno — dos instancias controlando
              ...
              {os === 'windows' && (
                <div className="os-panel active">
                  <p>
                    ...
                    <a href="#descargar">la sección de descargas</a>.
                  </p>
                  <p>
...
$ kongtrol --help`}</CodeBlock>
            ...
            <div id="certs" className="guide-section">
              ...
              <h2 className="guide-section-title">Archivos de conexión</h2>

              <p>
                <strong>Si ya tienes tus VPNs configuradas, esta sección no requiere ninguna acción.</strong>{' '}
                Kongtrol apunta a los archivos donde ya están — en el wizard simplemente
                escribes la ruta actual de cada archivo.
              </p>
              ...
              <ul style={{ marginTop: 4, paddingLeft: 20, lineHeight: 1.8 }}>
                <li>Recibes archivos de un compañero y necesitas guardarlos en algún lugar</li>
                <li>Tu empresa te entrega un <IC c=".crt" /> / <IC c=".key" /> nuevos y no tienes dónde ponerlos</li>
                <li>Quieres reorganizar todo en un solo directorio para tener orden</li>
              </ul>
...
[✓] Configuración válida.`}</CodeBlock>
            ...
            {/* 05 — Grupos y políticas */}
            <div id="groups" className="guide-section">
              <div className="guide-section-num">05</div>
              <h2 className="guide-section-title">Grupos y políticas de routing</h2>

              {/* ── Grupos ── */}
              <h3 style={{ marginBottom: 8 }}>Grupos</h3>
              <p>
...
kongtrol down --group work`}</CodeBlock>
              ...
              {/* ── Políticas ── */}
              <h3 style={{ marginTop: 28, marginBottom: 8 }}>Políticas de routing</h3>
              ...
              <p>
                ...
                en conectar suele ganar el tráfico general, y no puedes controlar qué va por dónde.
